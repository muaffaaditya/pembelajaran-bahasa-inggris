...
<script>
  const vocabQuestions = [
    { word: "A doctor can be called a...", options: ["surgeon", "Teacher", "lawyer"], answerIndex: 0 },
    { word: "Someone who practices medicine is a...", options: ["Driver", "practitioner", "counselor"], answerIndex: 1 },
    { word: "The medical doctor is known as a...", options: ["dentist", "Medic", "architect"], answerIndex: 0 }
  ];

  const imageQuestions = [
    {
      question: "Choose a picture that shows doctor's profession",
      images: [
        { src: "https://cdn-icons-png.flaticon.com/512/3037/3037205.png", isAnswer: true, alt: "Doctor" },

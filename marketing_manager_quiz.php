...
<script>
  const vocabQuestions = [
    {
      word: "A Marketing Manager is responsible for...",
      options: ["Managing marketing campaigns", "Writing software code", "Conducting medical surgeries"],
      answerIndex: 0
    },
    {
      word: "Which skill is essential for a Marketing Manager?",
      options: ["Data analysis", "Mechanical engineering", "Painting"],
      answerIndex: 0
    },
    {
      word: "Marketing Managers often work closely with the...",
      options: ["Sales team", "Architects", "Pilots"],
      answerIndex: 0
    }
  ];
  ...
  const imageQuestions = [
    {
      question: "Choose the image that represents a Marketing Manager",
      images: [
        {
        ...
        {
          src: "https://cdn-icons-png.flaticon.com/512/1683/1683973.png",
          isAnswer: false,
          alt: "Mechanic"
        }
      ]

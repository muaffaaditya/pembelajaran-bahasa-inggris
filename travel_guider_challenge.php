...
<head>
  ...
  <title>Travel Guider Vocabulary Challenge</title>
  <style>
    body {
...
<h1>Travel Guider Vocabulary Challenge</h1>
...
<div class="challenge-container">
  ...
  <textarea id="sentence" rows="4" placeholder="Example: The travel guider suggested visiting the local market for authentic experiences..."></textarea>
...
<script>
  const vocabList = [
    { english: "Itinerary", indonesian: "Jadwal Perjalanan" },
    { english: "Sightseeing", indonesian: "Wisata" },
    { english: "Backpacking", indonesian: "Wisata Ransel" },
    { english: "Tour Guide", indonesian: "Pemandu Wisata" },
    { english: "Travel Insurance", indonesian: "Asuransi Perjalanan" },
    { english: "Accommodation", indonesian: "Akomodasi" },
    { english: "Reservation", indonesian: "Reservasi" },
    { english: "Local Cuisine", indonesian: "Masakan Lokal" },
    { english: "Currency Exchange", indonesian: "Penukaran Mata Uang" },
    { english: "Passport", indonesian: "Paspor" },
    { english: "Tourist Attraction", indonesian: "Objek Wisata" },
    { english: "Travel Visa", indonesian: "Visa Perjalanan" },
    { english: "Adventure Travel", indonesian: "Perjalanan Petualangan" }
  ];
